package com.wang.vincent.mytcpio;
...
public class UiProcess {
    ...
    private TextView tv1, tv2, tv3, tv4, tvn1, tvn2, tvn3, tvn4,rele1;
    ...
    public UiProcess(LinearLayout mainLayout, Context context, HandleMsg hMsg, DataProcess dProcess) {
        ...
        rele1 = (TextView) mainLayout.findViewById(R.id.re1);
    ...
    public void setRelayState(int state) {//继电器1
    ...
    public void setRelayOnoff(TextView tv, ImageView im, byte state) {//继电器1
        if (state == 0x1) {
